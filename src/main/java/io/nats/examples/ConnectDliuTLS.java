...
// [begin connect_tls]
class DliuSSLUtils {
    public static String KEYSTORE_PATH = "src/main/resources/selfsigned/keystore.jks";
    public static String TRUSTSTORE_PATH = "src/main/resources/selfsigned/cacerts"; //"src/main/resources/cacerts";
...
public class ConnectDliuTLS {
    public static void main(String[] args) {

        try {
            SSLContext ctx = DliuSSLUtils.createSSLContext();
